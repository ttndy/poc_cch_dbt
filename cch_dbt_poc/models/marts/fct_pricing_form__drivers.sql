...
DRIVERS AS (
    SELECT 
        ...
        ,WALK."submission_type"                             AS "submission_type"
        ...
        ,CASE 
            ...
            WHEN WALK."driver" IN ('Mat OH Cost', 'Distribution', 'R&D') THEN 
                WALK."rate"
    ...
    FROM WALK
        ...
        LEFT JOIN WALK_PIVOT
            ...
            AND WALK."submission_type" = WALK_PIVOT."submission_type"
        ...
        LEFT JOIN AGG_RATES
            ...
            AND WALK."submission_type" = AGG_RATES."submission_type"
